...
class HistoryViewModelFilterTest {
    ...
    @Test
    fun `setActionFilter to WITH_ACTION should show only DISCOUNTED and REMOVED batches`() =
            runTest {
                ...
                assertThat(batches.map { it.actionTaken })
                        .containsExactly(WorkflowAction.DISCOUNTED, WorkflowAction.REMOVED)
            }
